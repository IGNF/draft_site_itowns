export const licenseCopy = {
  sectionTitle: { en: "License", fr: "Licence" },
  lead: {
    en: "iTowns is distributed under permissive terms: you may use, modify, publish, and sell the code, provided you retain the license and copyright notices when you share it.",
